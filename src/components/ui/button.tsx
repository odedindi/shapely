  ...
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        outline: 'border border-[var(--color-border)] bg-[var(--color-surface-raised)] text-[var(--color-content)] hover:bg-[var(--color-surface-alt)]',
        ghost: 'text-[var(--color-content)] hover:bg-[var(--color-surface-alt)]',
        destructive: 'bg-[var(--color-error)] text-white hover:opacity-90',
        secondary: 'bg-[var(--color-surface-alt)] text-[var(--color-content)] hover:bg-[var(--color-border)]',
